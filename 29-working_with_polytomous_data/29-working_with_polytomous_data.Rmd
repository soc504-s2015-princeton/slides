...
df2 <- tbl_df(x)
df2 <- filter(df2, !is.na(presvote)) ## remove missing values

df2 <- df2 %>%
mutate(party = ifelse(partyid == 0 | partyid == 1, "dem",  ## Democrats
         ifelse(partyid == 2 | partyid == 3 | partyid == 4, "indep", ## Independents
         ifelse(partyid == 5 | partyid == 6, "rep", NA))))  ## Republicans 
```
