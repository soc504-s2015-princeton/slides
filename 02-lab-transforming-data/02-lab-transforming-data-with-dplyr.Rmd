...
```{r}
filter(soccer.data, club %in% c("FC Barcelona", "Manchester United", "Real Madrid"))
```

## filter() with soccer data {.build}

How many rows are in a table of players who play Center Back and are over 198cm (6'5'') in height?  

* A. 225
* B. 7761
* C. 22763
```{r}
filter(soccer.data, position == "Center Back", height > 198)
```
...
Return a copy of soccer.data with the columns related to victories, ties, and defeats
```{r}
...
Answer the previous question using a helper function 
```{r}
