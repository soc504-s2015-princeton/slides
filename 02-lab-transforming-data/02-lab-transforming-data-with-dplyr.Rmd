...
Load dplyr:
```{r load.dplyr}
# install.packages("dplyr") # You will need to do this the first time on your own machines.
...
Create table with player-referee pairs where one or more red cards were given.
```{r}
...
Return a copy of soccer.data that contains columns "games"" up to and including "red.cards". 
```{r}
