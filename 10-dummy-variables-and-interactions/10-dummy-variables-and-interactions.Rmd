...
Sketch the graph of the relationship occupational presitge, education, and job type implied by these results.
...
p + geom_jitter(alpha=0.7) + 
  scale_color_manual(values = c("pink", "blue")) +
  geom_abline(intercept = inter.male, slope = slope.male, colour="blue", size=line.size) +
  geom_abline(intercept = inter.female, slope = slope.female, colour="pink", size=line.size) +
  expand_limits(x = 0, y = 0)
```
